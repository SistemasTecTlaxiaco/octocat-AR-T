  ...
  recognition.onresult = function (event) {
    ...
    if (voz === 'octocat muéstrame a IronCat' || voz === 'octocat Muéstrame a Iron Cat' || voz === 'octocat Muéstrame a Iron Man' || voz === 'Muéstrame a Iron Cat' || voz === 'Muéstrame Iron Cat') {
      ...
      if (contador == 0) {
        ...
        el.setAttribute("src", "https://cdn.glitch.global/16b440ad-e892-4085-9aee-0cf4887d328f/iron.glb?v=1653086416853");
    ...
    if (voz === 'octocat muéstrame la luna' || voz === 'octocat Muéstrame la luna') {
